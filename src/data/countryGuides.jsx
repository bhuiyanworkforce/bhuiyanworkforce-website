...
export const COUNTRY_GUIDES = {
  'saudi-arabia': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `Under Saudi labour law and BMET export regulations, employers must provide: a verified employment contract in Bengali before departure, return air ticket, accommodation, medical insurance, and timely salary payment via the Wage Protection System (WPS). Failure to comply with WPS can result in visa blacklisting.`,
      },
      {
  ...
  'uae': {
    ...
    sections: [
      {
        title: 'Why Recruit from Bangladesh for the UAE?',
  ...
  'poland': {
    ...
    sections: [
      {
        title: 'Why Recruit from Bangladesh for Poland?',
        content: `Poland has one of the lowest unemployment rates in the EU and severe labour shortages across construction, manufacturing, and agriculture. Bangladeshi workers are known for strong work ethic, physical endurance (important for construction), and reliability. Processing via VFS Global in Dhaka makes the visa application straightforward.`,
      },
      {
        title: 'In-Demand Sectors & Roles',
